package com.hafiz.pareapp.ui.penyewa.update_profile
...
import kotlinx.android.synthetic.main.penyewa_activity_edit_profile.*
...
class UpdateProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.penyewa_activity_edit_profile)
    ...
    private fun setUi(){
        getPassedUser()?.let {
            ...
            //et_nama.setText(it.penyewa!!.nama)
